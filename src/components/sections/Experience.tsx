...
const typeColors: Record<string, string> = {
    ...
    'Contract': 'bg-slate-800/50 text-slate-300 border-slate-700/60',
    'Internship': 'bg-slate-800/50 text-slate-300 border-slate-700/60',
};
    ...
    return (
        ...
        >
            ...
            <div className="relative">
                {/* Vertical line */}
                <div className="absolute left-[18px] top-2 bottom-2 w-px bg-slate-700" />
                    ...
                    {experiences.map((exp, i) => (
                        ...
                        >
                            ...
                            <span className="absolute left-0 top-5 flex h-9 w-9 items-center justify-center">
                                <span className="relative flex h-9 w-9 items-center justify-center rounded-full border border-slate-700 bg-slate-900">
