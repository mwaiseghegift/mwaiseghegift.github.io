...
export const portfolio = [
  {
    ...
    tags: ['Angular', 'PrimeNG', 'Chart.js', 'Node.js', 'Express.js', 'MongoDB', 'JWT']
  },
  {
  ...
  },
  {
    ...
    link: 'https://fms.jakehealthyoils.co.ke',
    tags: ['Angular', 'Python', 'Django', 'DRF']
  },
  {
...
export const contactInfo = {
  ...
  social: [
    ...
    },
    {
      type: 'whatsapp',
      label: 'WhatsApp',
      icon: 'Phone', // using Phone since lucide doesn't have whatsapp by default
